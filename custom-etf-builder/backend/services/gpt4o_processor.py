...
SYSTEM_PROMPT = (
    ...
    "  },\n"
    "  \"market_data\": {\n"
    "    \"analysis_summary\": { \"primary_sentiment\": \"bullish|bearish|neutral|mixed\", \"confidence_level\": 0.0, \"investment_horizon\": \"short-term|medium-term|long-term\" },\n"
    "    \"themes_identified\": [{ \"theme\": \"name\", \"confidence\": 0.9, \"market_size\": \"text\" }],\n"
    "    \"companies\": [\n"
    "      { \"symbol\": \"TICKER\", \"name\": \"Company Name\", \"sector\": \"GICS Sector\", \"industry\": \"Industry\", \"market_cap_billions\": 123.45, \"risk_category\": \"low|medium|high\", \"investment_thesis\": \"brief\" }\n"
    "    ],\n"
    "    \"market_context\": { \"current_environment\": \"text\", \"macro_factors\": [\"factor\"], \"risk_assessment\": \"text\" }\n"
    "  }\n"
    "}\n\n"
